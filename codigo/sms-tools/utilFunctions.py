...
def f0Twm(pfreq, pmag, ef0max, minf0, maxf0, f0t=0):
	...
	f0, f0error = TWM_p(pfreq, pmag, f0cf)		 # ALTERADO utilizando a funcao do proprio utilFunctions.py logo abaixo	
...
# 		Yh = UF_C.genSpecSines(N*sfreq[l,:]/fs, smag[l,:], sphase[l,:], N)   # generate spec sines
		Yh = genSpecSines_p(sfreq[l,:], smag[l,:], sphase[l,:], N, fs)   # generate spec sines
